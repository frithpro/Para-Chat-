...
BOT_TOKEN = "7991466412:AAGXrGNaNgRYbMDPIK31fykJp5vCo52QGPg"
bot = Bot(BOT_TOKEN, default=DefaultBotProperties(parse_mode=ParseMode.HTML))
storage = MemoryStorage()

DATABASE_PATH = "data/database.db"

ADMIN_USER_IDS = [5188998741, 1108186350]  # Using a tuple
ADMIN_USERNAMES = ["tufutbolista11", "aidachi_yourboss"]
